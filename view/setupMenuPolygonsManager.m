...
menubar.edit.showInfo.handle = uimenu(factMenu, 'label', 'Display &Infos', ...
...
e1 = uimenu(factMenu, 'label', 'Import &factors', ...
                   'callback', @(~,~) importFactors(obj), ...
                'accelerator', 'f');
e2 = uimenu(factMenu, 'label', '&Create factors', ...
                   'callback', @(~,~) createFactors(obj));

e3 = uimenu(factMenu, 'label', '&Save factors', ...
                   'callback', @(~,~) saveFactors(obj.model), ...
                     'enable', 'off', ...
                  'separator', 'on');

e4 = uimenu(factMenu, 'label', '&Display factors', ...
