...
%               ----------------------------------------------------------- 
                ...
                jEditMenu = jMenuBar.getComponent(1);
                jViewMenu = jMenuBar.getComponent(4);
                ...
                % Simulate mouse clicks to force the File main-menu to open & close
                jEditMenu.doClick; % open the File menu=
                jEditMenu.doClick; % close the menu
                % Simulate mouse clicks to force the File main-menu to open & close
                jViewMenu.doClick; % open the File menu
                jViewMenu.doClick; % close the menu
                
                pause(0.1);
                
                jFileMenu.getMenuComponent(1).setAccelerator(javax.swing.KeyStroke.getKeyStroke('ctrl shift N'));
                jFileMenu.getMenuComponent(2).setAccelerator(javax.swing.KeyStroke.getKeyStroke('ctrl alt N'));
                jFileMenu.getMenuComponent(10).setAccelerator(javax.swing.KeyStroke.getKeyStroke('ctrl shift Q'));
                
                jEditMenu.getMenuComponent(1).setAccelerator(javax.swing.KeyStroke.getKeyStroke('alt F'));
                jEditMenu.getMenuComponent(3).setAccelerator(javax.swing.KeyStroke.getKeyStroke('ctrl shift F'));
                
                jViewMenu.getMenuComponent(0).setAccelerator(javax.swing.KeyStroke.getKeyStroke('ctrl shift W'));
                jViewMenu.getMenuComponent(7).setAccelerator(javax.swing.KeyStroke.getKeyStroke('ctrl shift Z'));
            ...
            if strcmp(class(this.model), 'PolygonsManagerData')
                ...
                if strcmp(class(this.model.pca), 'Pca')
                    ...
                    if ~isempty(this.handles.Panels{1}.type)
                        ...
                        if ~ismember(this.handles.Panels{1}.type, {'pcaScores', 'pcaInfluence', 'pcaScores & Profiles'})
